...
\end{itemize}
\TODO{Dans les expressions shell ci-dessus, indiquez le résultat de l'évaluation du shell et le résultat final. Vous chercherez les solutions de ces exercices à la main, et vous vérifierez vos solutions en les tapant dans le shell.}
\begin{itemize}
\item x=p ; y=\$xwd ; \$y 
\item x=p ; \${x}'wd' 
\item x=p ; "\${x}'wd'" 
